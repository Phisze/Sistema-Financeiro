...
public class CategoriaDAO {
    ...
    public void atualizaCat(Categoria cat) {
    ...
    public void adiciona(Categoria contato) {
        ...
        try {
            ...
            stmt.setString(2, contato.getCatDesc());
            // executa
            stmt.execute();
            stmt.close();
